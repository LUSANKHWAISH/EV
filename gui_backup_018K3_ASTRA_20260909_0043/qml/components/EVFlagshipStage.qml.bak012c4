...
Item {
    ...
    Row {
        id: mainContainer
        anchors.top: ambientField.bottom
    ...
    Row {
        ...
        Repeater {
            ...
            delegate: Rectangle {
                ...
                property bool active: index === 0 // TODO: bind to actual state
                color: active ? Theme.stateColorIdle : Theme.backgroundBase
                opacity: active ? 0.8 : 0.4
            }
        }

        // Labels for steps (optional, but we can add subtle text)
        Row {
            spacing: Theme.spacingXS
            Repeater {
                model: 8
                delegate: Text {
                    text: ["OBSERVE", "UNDERSTAND", "PLAN", "RESEARCH", "BACKUP", "EXECUTE", "VERIFY", "COMPLETE"][index]
