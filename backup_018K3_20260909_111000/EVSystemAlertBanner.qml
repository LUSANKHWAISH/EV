...
Item {
    ...
    implicitHeight: hasContent ? Math.max(32, cardContainer.implicitHeight + Theme.spacingXXS * 2) : 0
    ...
    // Floating alert pill card positioned toward the right-side Telemetry rail
    Item {
        id: cardContainer
        anchors.right: parent.right
        anchors.rightMargin: Theme.spacingM
        anchors.verticalCenter: parent.verticalCenter
        width: Math.min(360, Math.max(240, parent.width * 0.32))
        ...
        // Card background (glassmorphic dark pill)
        Rectangle {
            anchors.fill: parent
            color: Qt.rgba(Theme.backgroundRaised.r, Theme.backgroundRaised.g, Theme.backgroundRaised.b, 0.88)
