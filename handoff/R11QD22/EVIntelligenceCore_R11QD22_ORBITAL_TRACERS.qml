...
// ============================================================================
// E.V. INTELLIGENCE CORE — R11Q-D2.2 ORBITAL TRACERS
// ============================================================================
//
// SAFE BASE:
...
Item {
    ...
    View3D {
        ...
        PrincipledMaterial {
            ...
            emissiveFactor:
                Qt.vector3d(
                    root.displayTone.r * 1.38,
                    root.displayTone.g * 1.38,
                    root.displayTone.b * 1.38
                )
        }
        ...
        PrincipledMaterial {
            ...
            emissiveFactor:
                Qt.vector3d(
                    0.30 + root.displayTone.r * 1.22,
                    0.30 + root.displayTone.g * 1.22,
                    0.30 + root.displayTone.b * 1.22
                )
        }
                ...
                delegate: Model {
                    ...
                    scale:
                        Qt.vector3d(
                            ...
                            + root.effectiveListenLevel * 0.003,
