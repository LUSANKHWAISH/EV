...
Window {
    ...
    CinematicStage { id:stage;anchors.fill:parent;enabled:!approvalSurface.visible&&!providerSurface.visible;model:lab;targetWindow:window;onCloseRequested:window.close() }
